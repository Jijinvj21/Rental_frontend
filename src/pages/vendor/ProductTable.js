...
function UserTable() {
  ...
  function addBtn() {
    return <button className="bg-boxColor p-2 rounded-md">AddCycle</button>;
  }
          ...
          .then(async () => {
            addCycleValidationSchema
              ...
              .then(async () => {
                ...
                setUplod(false);
                await axios
                  .post("/vendor/insert_cycle", datas, {
                    headers: {
        ...
        <div className="bg-boxColor      my-auto w-full flex flex-row justify-center items-center rounded-3xl  ">
          ...
          >
            ...
            <input
              ...
              value={inputData.name}
              onChange={(e) =>
                setInputData({ ...inputData, speed: e.target.value })
              }
            />
            <input
              className="bg-bgColor  rounded-full   shadow-lg p-2 m-2 w-4/5  focus:outline-none"
            ...
            <input
              ...
              value={inputData.name}
              onChange={(e) =>
                setInputData({ ...inputData, breake: e.target.value })
              }
            />
            <input
              className="bg-bgColor  rounded-full   shadow-lg p-2 m-2 w-4/5  focus:outline-none"
              ...
              value={inputData.name}
              onChange={(e) =>
                setInputData({ ...inputData, tyresize: e.target.value })
              }
            />
            <input
              className="bg-bgColor  rounded-full   shadow-lg p-2 m-2 w-4/5  focus:outline-none"
            ...
            <input
              ...
              value={inputData.name}
              onChange={(e) =>
                setInputData({ ...inputData, priceinclude: e.target.value })
              }
            />
            <input
              className="bg-bgColor  rounded-full   shadow-lg p-2 m-2 w-4/5  focus:outline-none"
              ...
              value={inputData.name}
              onChange={(e) =>
                setInputData({ ...inputData, securitydeposit: e.target.value })
              }
            />
            <input
              className="bg-bgColor  rounded-full   shadow-lg p-2 m-2 w-4/5  focus:outline-none"
              ...
              value={inputData.name}
              onChange={(e) =>
                setInputData({ ...inputData, terms: e.target.value })
              }
            />
            <input
              className="bg-bgColor  rounded-full   shadow-lg p-2 m-2 w-4/5  focus:outline-none"
    ...
    let table_head = {
      ...
      Status: (
        <button
          ...
          onClick={() => {
            axios
              .get(`/vendor/cycleStatus_Update/${data._id}`, {
                headers: {
                  Authorization: `Bearer ${token}`,
