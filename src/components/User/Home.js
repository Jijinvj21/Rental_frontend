  ...
  return (
    <div className='h-full container-fluid  '>
      <div className='h-screen flex flex-col justify-center items-center ' style={{ backgroundImage: `url("https://res.cloudinary.com/dczou8g32/image/upload/v1678511871/project2/hom_bmrsnd.jpg")`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}>
        ...
        <div class="flex flex-row w-4/6  md:w-1/2 lg:w-1/4 drop-shadow-2xl  ">
      ...
      <div class="flex items-center justify-center p-5 ">
        <div class="grid grid-cols-1  gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div class=" bg-boxColor rounded-2xl  group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
            <div class="pt-14 w-96">
              <img class="object-contain transition-transform duration-500 group-hover:rotate-3 group-hover:scale-125" src="https://res.cloudinary.com/dczou8g32/image/upload/v1678528034/project2/pngwing.com_3_z3mnie.png" alt="" />
            </div>
            <div class="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70"></div>
            <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
              <h1 class="font-dmserif text-3xl font-bold text-white">PREMIUM</h1>
              <p class="mb-3 text-lg italic text-white opacity-0 max-h-[150px] transition-opacity duration-300 group-hover:opacity-100">Cycling is more than just a sport. It's a way of life. It's a journey that takes you to new places</p>
          ...
          <div class=" bg-boxColor rounded-2xl  group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
            <div class="pt-14 w-96">
              <img class="h-full  w-full object-cover transition-transform duration-500 group-hover:rotate-3 group-hover:scale-125" src="https://res.cloudinary.com/dczou8g32/image/upload/v1678528023/project2/pngwing.com_enlxsl.png" alt="" />
            </div>
            <div class="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70"></div>
            <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
              <h1 class="font-dmserif text-3xl font-bold text-white">GEAR</h1>
              <p class="mb-3 text-lg italic text-white max-h-[150px]  opacity-0 transition-opacity duration-300 group-hover:opacity-100">bicycle with gear provides a variety of gear ratios to choose from. This gear ratio makes cycling easy</p>
              <button class="rounded-full bg-neutral-900 py-2 px-3.5 font-com text-sm capitalize text-white shadow shadow-black/60">See More</button>
            </div>
          </div>
          <div class=" bg-boxColor rounded-2xl   group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
            <div class="pt-14 w-96">
              <img class="h-full  w-full object-cover transition-transform duration-500 group-hover:rotate-3 group-hover:scale-125" src="https://res.cloudinary.com/dczou8g32/image/upload/v1678528022/project2/pngwing.com_2_buetue.png" alt="" />
            </div>
            <div class="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70"></div>
            <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
              <h1 class="font-dmserif text-3xl font-bold text-white">ELECTRIC</h1>
              <p class="mb-3 text-lg italic text-white max-h-[150px] opacity-0 transition-opacity duration-300 group-hover:opacity-100">An electric bicycle  is a motorized bicycle with an integrated electric motor used to assist propulsion</p>
              <button class="rounded-full bg-neutral-900 py-2 px-3.5 font-com text-sm capitalize text-white shadow shadow-black/60">See More</button>
            </div>
          </div>
          <div class=" bg-boxColor rounded-2xl  group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
            <div class="pt-14 w-96">
              <img class="h-full  w-full object-cover transition-transform duration-500 group-hover:rotate-3 group-hover:scale-125" src="https://res.cloudinary.com/dczou8g32/image/upload/v1678528510/project2/cu_q0h8vj.png" alt="" />
            </div>
            <div class="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70"></div>
            <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
              <h1 class="font-dmserif text-3xl font-bold text-white">NON GEAR</h1>
              <p class="mb-3 text-lg italic text-white opacity-0 max-h-[150px] transition-opacity duration-300 group-hover:opacity-100">The speed that you can reach on such bikes depends completely on how fast or slow you pedal</p>
              <button class="rounded-full bg-neutral-900 py-2 px-3.5 font-com text-sm capitalize text-white shadow shadow-black/60">See More</button>
            </div>
          </div>
        </div>
      ...
      <div className=' h-3/6 md:h-[300px]  lg:h-[500px] mt-20    flex flex-col justify-center items-center ' style={{ backgroundImage: `url("https://res.cloudinary.com/dczou8g32/image/upload/v1678605023/project2/opacity_ndaiel.png")`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}>
        ...
        <div className=' col-span-4 pt-9'>
          <div className='grid grid-cols-3 gap-4 pr-3 pl-3 mb-10 '>
            ...
            <div className='flex flex-col  items-center' >
              <svg class="h-8 mb-2 w-8 text-white" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z" />  <circle cx="12" cy="12" r="9" />  <polyline points="12 7 12 12 15 15" /></svg>
