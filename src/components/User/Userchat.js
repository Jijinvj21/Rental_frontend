...
function Userchat() {
    ...
    const chatButton = () => {
        ...
        return (
            ...
            <div onClick={handleChat} className=' flex justify-center items-center z-30 fixed bottom-20 right-10 rounded-full   shadow shadow-[#182124] bg-boxColor w-10 h-10 md:w-20 md:h-20 text-center '>
                <svg className="md:h-12 md:w-12 h-6 w-6 text-white" width="24" height="24" viewBox="0 0 24 24" strokeWidth=".5" stroke="currentColor" fill="none" strokeLinecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z" />  <path d="M12 20l-3 -3h-2a3 3 0 0 1 -3 -3v-6a3 3 0 0 1 3 -3h10a3 3 0 0 1 3 3v6a3 3 0 0 1 -3 3h-2l-3 3" />  <line x1="8" y1="9" x2="16" y2="9" />  <line x1="8" y1="13" x2="14" y2="13" /></svg>
            </div>
        )
    }
