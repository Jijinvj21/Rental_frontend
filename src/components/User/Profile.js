      ...
      <div className="w-1/2 bg-boxColor p-5   mx-auto m-10 rounded-3xl ">
        ...
        >
          ...
          <div className="flex md:flex-row flex-col justify-center mt-5 mb-1 md:mb-3   ">
            <input
              type="text"
              className="outline-none rounded-full text-center text-sm md:text-lg bg-bgColor p-2 w-full md:w-44 mb-2 md:m-1 "
              value={user}
              onChange={(e) => {
          ...
          {button ? (
            <p className="text-white       rounded-full  shadow-lg   mx-2    bg-bgColor hover:bg-bgColor focus:ring-4 focus:ring-blue-300 font-medium  text-sm px-5 py-2 text-center mr-2 dark:bg-bgColor  dark:focus:ring-bgColor inline-flex items-center">
              SUBMIT
            </p>
          ) : upload ? (
            <button className="text-white      rounded-full  shadow-lg   mx-2    bg-bgColor hover:bg-bgColor focus:ring-4 focus:ring-blue-300 font-medium  text-sm px-5 py-2 text-center mr-2 dark:bg-bgColor dark:hover:bg-[#30444a] dark:focus:ring-bgColor inline-flex items-center">
              SUBMIT
            </button>
          ) : (
            <button
