    ...
    return (
        <div className=' my-10  pt-10'>
            <div className='w-1/2 bg-boxColor p-5   mx-auto m-10 rounded-3xl '>
                ...
                {upload ?
                            <button class="text-white      rounded-full  shadow-lg   mx-2    bg-bgColor hover:bg-bgColor focus:ring-4 focus:ring-blue-300 font-medium  text-sm px-5 py-2 text-center mr-2 dark:bg-bgColor dark:hover:bg-[#30444a] dark:focus:ring-bgColor inline-flex items-center">SUBMIT</button> :
