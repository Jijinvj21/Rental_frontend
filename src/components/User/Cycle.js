...
function Cycle(props) {
    ...
    const [formDate, setFromDate] = useState(fromValue?fromValue:today.toISOString().substr(0, 10)); // Set today's date as default value
  const [toDate, setToDate] = useState(toValue?toValue:today.toISOString().substr(0, 10)); // Set today's date as default value
        ...
        <div>
            ...
            <div className='flex flex-col  '>
                ...
                <div className='min-h-[600px] pt-5'>
                    ...
                    { props?.data?.data?.user?.[0] ? '': <div className='flex  min-h-[600px]   justify-center items-center'><p className=' text-center '> NO DATA ARE AVAILABLE</p></div>}
                                ...
                                <div className=" max-w-sm shadow-lg overflow-hidden rounded-3xl m-5 ">
                                    <div className='relative'>
                                        <div className=' absolute right-1 top-3 '>
                                            ...
                                            <a className="  cursor-pointer mr-5  rounded-full bg-bgColor  w-10 h-10 flex items-center justify-center" onClick={() => navigate(`/singlecycle`, { state: data })}>
                                                +
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="  p-4 text-center bg-boxColor">
                                        ...
                                        <span className=" text-2xl  mt-4 grid grid-cols-3">
                                            <hr />
                                            <h1 className='-mt-4 text-center text-[16px]'>${data.price}/day</h1>
                                            <hr />
                                        </span>
                                        <div className="mt-4 ">
