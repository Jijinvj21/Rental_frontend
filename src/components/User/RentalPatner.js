  ...
  return (
    <div>
      <div
        ...
        style={{
          backgroundImage: `url("https://res.cloudinary.com/dczou8g32/image/upload/v1680751681/project2/cy2_vucmpk.jpg")`,
          backgroundSize: "cover",
          backgroundRepeat: "no-repeat",
          backgroundPosition: "center",
        }}
      >
        <h1 className="text-3xl text-center md:text-5xl md:p-3 p-5">
          BECOME OUR PARTNER
        </h1>
        <h1 className="text-2xl text-center md:text-3xl md:p-3 p-5">
        ...
        <h1 className="text-1xl text-center md:text-2xl md:p-3 p-5">
          {" "}
          who rent your cycle on basis
        </h1>
        {localStorage.getItem("vendor") ? (
          <h1 className="bg-bgColor p-2 text-xs  md:p-3 rounded-full tracking-widest md:tracking-widested  m-2 md:m-3">
            REGISTER YOUR CYCLE NOW
          </h1>
        ) : (
          <Link to="/vendor/signup">
            <button className="bg-bgColor p-2 text-xs  md:p-3 rounded-full tracking-widest md:tracking-widested  m-2 md:m-3">
              REGISTER YOUR CYCLE NOW
            </button>
          </Link>
        )}
      ...
      <div className="bg-boxColor grid md:grid-cols-2 ">
        ...
        <div className="flex flex-col justify-center items-center p-3">
          ...
          <h1 className="text-xs text-center md:text-xl py-5 ">
            ...
            This is reflected on the changing consumption habits, as consumers
            are more and more interested to buy access, experiences and
            convenience, rather than ownership. At Rentle, our mission is to
            drive the sustainable consumption of durable goods. As a Rentle
            partner, you can be part of this movement and accelerate it, while
      ...
      <div className="flex flex-col justify-center items-center ">
        ...
        <div className="grid md:grid-cols-3 ">
          <div className="flex flex-col  items-center p-5 border-2 m-5  rounded-3xl ">
            ...
            <h1 className="text-center p-2 md:py-5">
              Photos & details of your cycles will be listed on our website
            </h1>
          </div>
          <div className="flex flex-col  items-center p-5 border-2 m-5 rounded-3xl">
            ...
            <h1 className="text-center p-2 md:py-5">
              Customer books your cycle for their need
            </h1>
          </div>
          <div className="flex flex-col  items-center p-5 border-2 m-5 rounded-3xl">
            ...
            <h1 className="text-center p-2 md:py-5">
              Monthly rent of the cycle is transferred directly into your bank
              account
            </h1>
          </div>
        </div>
