    ...
    return (
      <Fragment>
        ...
        >
          ...
          <button
            onClick={closeModal}
            className="text-white      rounded-lg  shadow-lg      mt-6   bg-bgColor hover:bg-bgColor focus:ring-4 focus:ring-blue-300 font-medium  text-sm px-5 py-2.5 text-center  dark:bg-bgColor dark:hover:bg-[#30444a] dark:focus:ring-bgColor inline-flex items-center"
          >
            SUBMIT
          </button>
        </form>
                    ...
                    <td className=" text-center p-3 ">
                      <div className="flex justify-center">
                        {Array.from({ length: data.stars }).map((_, index) => (
                          <svg
                            key={index}
                            className="h-3 w-3 ml-1 text-[#ffbe0c]"
                            viewBox="0 0 24 24"
                            fill="currentColor"
                            stroke="currentColor"
                            strokeWidth="2"
