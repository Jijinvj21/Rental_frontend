        ...
        <div className='bg-boxColor w-10/12 md:w-3/5 h-[600px] rounded-3xl shadow-lg grid md:grid-cols-2'>
          ...
          <form method='post' onSubmit={handleOtp}>
            <div className=' flex flex-col  items-center'>
              ...
              {state ?
                <button class="text-white      rounded-full  shadow-lg   mt-12      bg-bgColor hover:bg-bgColor focus:ring-4 focus:ring-blue-300 font-medium  text-sm px-5 py-2.5 text-center mr-2 dark:bg-bgColor dark:hover:bg-[#30444a] dark:focus:ring-bgColor inline-flex items-center">VERIFY</button> :
                <button disabled type="button" class="text-white      rounded-full  shadow-lg    mt-12     bg-bgColor hover:bg-bgColor focus:ring-4 focus:ring-blue-300 font-medium  text-sm px-5 py-2.5 text-center mr-2 dark:bg-bgColor  dark:focus:ring-bgColor inline-flex items-center">
