      ...
      loginvalidationSchema
        ...
        .then(async () => {
          await axios
            ...
            .then(() => {
              navigate(`/${props.type}/Login/Otp/Verify`, {
                state: { mobile: mobile },
              });
            })
            .catch((err) => {
      ...
      <div className="flex flex-col justify-center items-center h-screen  ">
        <div className="bg-boxColor w-10/12 md:w-3/5   h-[600px] rounded-3xl   shadow-lg grid md:grid-cols-2">
          <div
            ...
            style={{
              backgroundImage: `url("https://res.cloudinary.com/dczou8g32/image/upload/v1678511254/project2/ljc_k8qbgk.jpg")`,
          ...
          <form method="post" onSubmit={handleLogin}>
            <div className="mt-10 md:rounded-l-none rounded-3xl  w-full flex flex-col items-center justify-between  ">
              ...
              <Link to={`/${props.type}/signup`}>
                <h6 className="text-lg text-center mt-12">
                  CREATE AN ACCOUNT{" "}
                </h6>
