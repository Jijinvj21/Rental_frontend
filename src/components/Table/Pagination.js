...
function Pagination() {
  ...
  let pre;
  let next;
  counter !== totalPage && counter !== 0 && i.data?.total
    ? (next =
        "inline-flex items-center px-4 py-2 text-sm font-medium  bg-boxColor rounded-l hover:bg-boxColor dark:bg-boxColor dark:border-boxColor  dark:hover:bg-[#315a5a] ")
    : (next = "hidden");
  counter > 1 && first !== 0
    ? (pre =
        "inline-flex items-center px-4 py-2 text-sm font-medium  bg-boxColor rounded-l hover:bg-boxColor dark:bg-boxColor dark:border-boxColor  dark:hover:bg-[#315a5a] ")
