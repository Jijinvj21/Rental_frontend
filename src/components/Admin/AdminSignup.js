      ...
      <div className="flex justify-center items-center h-screen  ">
        <div className="bg-boxColor w-10/12 md:w-3/5   h-[600px] rounded-3xl   shadow-lg grid md:grid-cols-2">
          <div
            ...
            style={{
              backgroundImage: `url("https://res.cloudinary.com/dczou8g32/image/upload/v1678510444/project2/otp_d4dg2c.png")`,
          ...
          <form method="post" onSubmit={handleSubmit}>
            <div className="mt-10 md:rounded-l-none rounded-3xl  w-full flex flex-col items-center ">
              <h1 className=" mt-5 text-3xl sm:text-4xl text-center ">
                ADMIN LOGIN
              </h1>
              <input
              ...
              />
              <button className="bg-bgColor rounded-full  w-3/5 shadow-lg mt-12 text-center pt-3 pb-2  focus:outline-none">
                SUBMIT
              </button>
            </div>
          </form>
