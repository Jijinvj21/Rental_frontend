...
function SuccessMessage() {
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
          ...
          <h1 className="text-3xl font-extrabold  mb-4 text-center md:text-left">Success</h1>
          <p className="text-lg  mb-4 text-center md:text-left">We received your purchase request </p>
